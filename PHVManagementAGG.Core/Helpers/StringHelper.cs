...
namespace PHVManagementAGG.Core.Helpers
{
    public static class StringHelper
    {
        ...
        public static string GetHeader(HttpRequest hd, string headerKey)
        {
            hd.Headers.TryGetValue(headerKey, out var headerValue);
